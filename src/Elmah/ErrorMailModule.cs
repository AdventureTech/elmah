...
[assembly: Elmah.Scc("$Id: ErrorMailModule.cs 710 2010-02-21 15:37:25Z jamesdriscoll@btinternet.com $")]
    ...
    public class ErrorMailModule : HttpModuleBase, IExceptionFiltering
    {
        ...
        protected virtual void OnError(object sender, EventArgs e)
        {
            HttpContext context = ((HttpApplication) sender).Context;
				OnError(context.Server.GetLastError(), new HttpContextWrapper(context));
        }
